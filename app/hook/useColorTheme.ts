...
export const useColorTheme = () => {
	const {colorScheme} = useColorScheme()
		const charcoalToTwilight = colorScheme	=== 'light' ? Color.charcoal : Color.twilight
	...
	const silverToMidnight = colorScheme === 'light' ? Color.silver : Color.midnight
	...
	const midnightToSilver = colorScheme === 'light' ? Color.midnight : Color.silver
