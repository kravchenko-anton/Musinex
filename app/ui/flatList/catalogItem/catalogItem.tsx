		...
		>
			<View className={'flex-row items-center'}>
				...
				<View className='ml-3 max-w-[250px]'>
					<Title fontFamily={'Montserrat_600SemiBold'} size={textSize}>{props.text1}</Title>
					{
						props.text2 && <Title color={'lightGray'} fontFamily={'Montserrat_300Light'} size={textSize * 0.75}>
							{props.text2}
						</Title>
					}
				</View>
